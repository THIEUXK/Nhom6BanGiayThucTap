        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShoeDetail_Brands_ShoeId",
                        column: x => x.ShoeId,
                        principalTable: "Brands",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_ShoeDetail_Categories_ShoeId",
                        column: x => x.ShoeId,
                        principalTable: "Categories",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_ShoeDetail_Color_ShoeId",
                        column: x => x.ShoeId,
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_ShoeDetail_Size_ShoeId",
                        column: x => x.ShoeId,
                        principalTable: "Size",
                        principalColumn: "id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_CartDetail_ShoeDetail_CartId",
                        column: x => x.CartId,
                        principalTable: "ShoeDetail",
                        principalColumn: "id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_OrderDetail_ShoeDetail_OrderId",
                        column: x => x.OrderId,
                        principalTable: "ShoeDetail",
                        principalColumn: "id");
                });
